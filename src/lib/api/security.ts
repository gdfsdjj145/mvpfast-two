 ...
 * @example
 * ```ts
 * import { withSecurity, withSecureApi } from '@/lib/api';
 *
 * // 基础安全防护
...
import { withRateLimit, RateLimitConfig, getClientIdentifier } from './rate-limit';
import { withCsrfProtection, sanitizeObject, sanitizeMongoQuery } from '../security';
import { logSecurityEvent } from '../core/logger';
