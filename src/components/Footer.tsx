  ...
  return (
    <footer className="bg-neutral text-neutral-content">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16">
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-neutral-content/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-xs text-neutral-content/50 hover:text-neutral-content/70 transition-colors"
          >
            {t('beian.text')}
          </a>
        </div>
