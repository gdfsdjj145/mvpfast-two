    ...
    <>
      {isLoading ? (
        ...
        <div className="text-center py-16 bg-white rounded-xl shadow-md">
          ...
          >
            <div className="inline-block bg-gradient-to-r cursor-pointer from-pink-500 to-purple-600 text-white font-bold py-3 px-8 rounded-full text-lg hover:from-pink-600 hover:to-purple-700 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110">
              复制分享链接
            </div>
          </ClipboardCopyButton>
        </div>
